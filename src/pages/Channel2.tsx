...
const Channel2 = () => {
  ...
  useEffect(() => {
    ...
    const handleLoadStart = () => {
      console.log('Loading Spicks & Specks stream...');
    };
    ...
    // Set the stream URL
    video.src = 'https://tv.meridianstem.com/stream/channels/2.m3u8';
    video.load();
  ...
  return (
    <div className="safe-fill min-h-screen bg-black flex flex-col items-center justify-center relative">
      ...
      >
        <source src="https://tv.meridianstem.com/stream/channels/2.m3u8" type="application/x-mpegURL" />
      ...
      <div className="absolute bottom-6 left-6 bg-purple-500 bg-opacity-80 text-white px-6 py-3 rounded-xl backdrop-blur-sm flex items-center">
        <img src="/sas_logo.png" className="h-10 w-10 mr-3" alt="" />
